...
urlpatterns = [
    ...
    path('create/', CBS_views.PostCreateCBS_View.as_view(), name='post_create'),
    path('<int:pk>/update/', CBS_views.PostUpdateCBS_View.as_view(), name='post_update'),
    path('<int:pk>/delete/', CBS_views.PostDeleteCBS_View.as_view(), name='post_delete'),
